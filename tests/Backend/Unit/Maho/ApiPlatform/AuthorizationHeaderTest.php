 ...
 * listeners and the OAuth2 authenticator share. The helper mirrors Symfony's
 * HeaderAccessTokenExtractor (not shipped in this project); these tests pin the contract the call sites
